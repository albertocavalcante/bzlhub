...
// serve process. Gated by CANOPY_BAZEL_LIVE=1 because it requires
...
const (
	...
	bazelEnvGate = "CANOPY_BAZEL_LIVE"
...
func TestE2E_BazelModGraphResolvesViaCanopy(t *testing.T) {
	...
	canopyCmd.Env = append(os.Environ(), "CANOPY_DISABLE_SHADOW_DETECTION=true")
