// Tool-only module: pins versions for the dev/CI tools assay invokes
// via `go tool -modfile=tools.go.mod ...`. Kept out of the main go.mod
...
module github.com/albertocavalcante/assay/tools
