...
// ResolveLoadedFile normalizes a label-style load() module path
// against the calling file's location, returning the module-relative
// file path of the target. Returns ok=false for external loads (which
// can't be resolved without the external repo on disk) or for
// unrecognized syntaxes.
//
...
func ResolveLoadedFile(callerRelPath, loadPath string) (string, bool) {
	// "@//pkg:..." is the canonical-name-of-this-module form; treat as local.
