...
{{- define "canopy.labels" -}}
helm.sh/chart: {{ include "canopy.chart" . }}
{{ include "canopy.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
{{- define "canopy.selectorLabels" -}}
app.kubernetes.io/name: {{ include "canopy.name" . }}
...
*/}}
{{- define "canopy.cronName" -}}
{{- $base := include "canopy.fullname" .root | trunc 38 | trimSuffix "-" -}}
...
Caller signature:
  {{- include "canopy.annotations" (dict "ctx" . "specific" .Values.service.annotations) | nindent 2 }}
*/}}
{{- define "canopy.annotations" -}}
...
{{- define "canopy.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
{{- default (include "canopy.fullname" .) .Values.serviceAccount.name -}}
{{- else -}}
...
*/}}
{{- define "canopy.imagePullSecrets" -}}
{{- $seen := dict -}}
{{- $secrets := list -}}
